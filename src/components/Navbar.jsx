...
const Navbar = () => {
  ...
  <ul>
    <li>
      <a href="/contact" className="bg-green-700 hover:bg-gradient-to-r from-green-800 via-green-500 to-green-800 shadow-lg text-white mt-32 rounded-md font-medium my-6 mx-auto px-6 md:px-10 py-3 z-0 transform rotate-90">
        Kontakta oss
      </a>
    </li>
  </ul>
