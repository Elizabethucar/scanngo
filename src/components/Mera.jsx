    ...
    <div className="w-full bg-gray-200 mt-24 py-16 px-12 mb-0 relative">
      <div className="flex flex-col justify-center">
        ...
        <p className="text-black">
          ...
          länge du vill få leverans. Hos oss kan du välja din egen veckomeny
          genom att klicka hem de matlådor som passar dig och dina behov eller
          så kan du välja någon av våra färdiga kassar. Som anställd betalar du
          enkelt genom att scanna QR koden på kylen för att komma åt din
          matlåda. Dessutom sparar du massa pengar på att köpa matlådor istället
          för att äta lunch ute varje dag! Låt oss ta hand om din lunch så att
          du kan fokusera på jobbet.
        </p>
      </div>
    </div>
  );
