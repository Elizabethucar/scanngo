...
const Mera = () => {
  return (
    <div  className='w-full bg-gray-200 mt-16 py-12 px-12 mb-0 relative'>
        <div className='flex flex-col justify-center'>
          ...
          <p className='text-black'> På Scan´N Go erbjuder vi ett smidigt sätt att få god, hälsosam mat direkt till arbetsplatsen. 
          Våra hälsosamma matlådor tillagas av våra kockar med fokus på näring och god smak för att du ska kunna äta gott och samtidigt,få bra energi under hela arbetsdagen.

    Vi erbjuder enkel beställning och bekväm leverans veckovis så att du inte behöver lämna arbetsplatsen,
    dessutom har vi ingen bindningstid - du bestämmer själv hur ofta och länge du vill få leverans.
